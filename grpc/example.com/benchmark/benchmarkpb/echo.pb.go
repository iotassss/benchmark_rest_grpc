...
var file_echo_proto_depIdxs = []int32{
	0, // 0: benchmark.EchoService.Echo:input_type -> benchmark.EchoRequest
	1, // 1: benchmark.EchoService.Echo:output_type -> benchmark.EchoResponse
